            ...
            <div>
                ...
                <section className="pricing py-5">
                    <div className="container py-md-5">
                        <h3 className="heading text-capitalize text-center mb-3 mb-sm-5">SALON SERVICES</h3>
                ...
                <section className="pricing py-5">
                    <div className="container py-md-5">
                        <h3 className="heading text-capitalize text-center mb-3 mb-sm-5"> Our SPA Services</h3>
                        <div className="row pricing-grids">
                            <div className="col-lg-6  mb-lg-0 mb-5">
                                <div className="padding">
