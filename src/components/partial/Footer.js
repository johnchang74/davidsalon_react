          ...
          <div className="container-fluid">
            <div className="row footer-top-inner-w3ls">
              ...
              <div className="col-lg-4 badge-title">
                <a href="/contact" className="concept-badge-1">
                  Please visit our salon to experience our service and products
                </a>
                ...
                <div className="footer-row">
                  <div className="col-md-1-3 footer-badge">
                    <div className="hair-color1 tooltip">
                      hc
                      <span className="tooltiptext">
                        Hair color: Exclusive Aveda Hair Color - these locations
                        only use Aveda hair color-up to 99% naturally
                        derived-and no other companies' hair color products.
                      </span>
                    </div>
                  </div>
                  <div className="col-md-1-3 footer-badge">
                    <div className="hair-color2 tooltip">
                      pp
                      <span className="tooltiptext">
                        Aveda+ Rewards: These locations participate in the
                        Aveda+ Rewards program. To learn about this program,
                        visit aveda.com/avedaplus.
                      </span>
                    </div>
                  </div>
                  <div className="col-md-1-3 footer-badge">
                    <div className="hair-color3 tooltip">
                      ss
                      <span className="tooltiptext">
                        Signature Spa Services: Performs Aveda Signature Spa
                        Services - these locations perform spa services such as
                        facials, massages and other body treatments using only
                        Aveda skin, body and aroma products.
                      </span>
                    </div>
                  </div>
                  <div className="col-md-1-3 footer-badge">
                    <div className="hair-color4 tooltip">
                      sr
                      <span className="tooltiptext">
                        Sensory Rituals: Performs Complimentary Sensory Rituals
                        - these locations consistently deliver the Aveda Guest
                        Service Experience by providing complimentary Comforting
                        Tea, stress relieving rituals, aroma sensory journey and
            ...
            <Row>
              <Col>
                <p className="copy-right-grids text-li text-center my-sm-4 my-4">
                  © 2021 David Kim Salon de Beauté. All Rights Reserved.
                </p>
              </Col>
            </Row>
            <Row>
